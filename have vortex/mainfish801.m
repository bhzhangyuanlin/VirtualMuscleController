...
end_time     = start_time + 30;
 W_tot_t=zeros(1,time * times);
 W_use_t=zeros(1,time * times);
  W_tot=0;
   W_use=0;
%%%%%%%%%%%%%   PID参数变量声明   %%%%%%%%%%%%%%
f=2;
Kp_1         = 7;          %第一个关节（身体）的PID参数
Ki_1         = 0;
Kd_1         = 0;
err_1        = 0;
d_err_1      = 0;
